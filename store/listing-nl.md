...
| Asset | File | Spec |
| --- | --- | --- |
| App icon | `listing-icon-512.png` | 512×512 PNG |
| Feature graphic | `feature-graphic-1024x500.png` | 1024×500 PNG |
| Phone screenshots | to be taken on a phone | 2–8 images, 16:9 or 9:16, 320–3840 px |

## Category and tags

- Category: **Productivity** (not Finance — no money moves through the app)
- Tags: expense tracking, event planning, bills and payments, whichever of those the picker offers

## Screenshots to take

On a phone, with a made-up event so no real names are shown:
...
Two is the minimum Play accepts; four or five tells the story.
